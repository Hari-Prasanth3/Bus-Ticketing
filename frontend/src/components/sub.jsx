...
const TicketScreen = () => {
  ...
  // Split the seats into three rows
              ...
              <Card className="w-50 p-4">
                ...
                <form onSubmit={ticketBookingButton}>
                  <Button
                    type="submit"
                    variant="outlined"
                    className="bg-black text-white border-white hover:bg-white hover:text-black hover:border-black mt-4"
                  >
                    Pay ${totalPrice}
                  </Button>
                </form>
          ...
          <Container className="w-50 h-50">
            <Card className="w-[50%] h-80">
              <div className="mt-0 h-auto">
                <Button
                  className="mt-2 ml-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded"
                  variant="outlined"
